...
func (sc *SessionCreate) SetAudio(s string) *SessionCreate {
	sc.mutation.SetAudio(s)
	return sc
}
...
func (sc *SessionCreate) AddSegmentIDs(ids ...string) *SessionCreate {
	sc.mutation.AddSegmentIDs(ids...)
	return sc
}

// AddSegments adds the "segments" edges to the Segment entity.
func (sc *SessionCreate) AddSegments(s ...*Segment) *SessionCreate {
...
func (sc *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.Audio(); ok {
